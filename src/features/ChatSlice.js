...
export const chatSlice=createSlice({
    ...
    extraReducers(builder){
        ...
        .addCase(create_open_Conversations.pending, (state,action)=>{
            state.status="loading";
        })
        .addCase(create_open_Conversations.fulfilled, (state,action)=>{
            state.status="succeeded";
            state.activeConversation=action.payload;
            state.files=[]
        })
        .addCase(create_open_Conversations.rejected, (state,action)=>{
            state.status="failed";
            state.error=action.payload
        }) 
        .addCase(getConversationsMessages.pending, (state,action)=>{
            state.status="loading";
        })
        .addCase(getConversationsMessages.fulfilled, (state,action)=>{
            state.status="succeeded";
            state.messages=action.payload;
        })
        .addCase(getConversationsMessages.rejected, (state,action)=>{
            state.status="failed";
            state.error=action.payload
        }) 
