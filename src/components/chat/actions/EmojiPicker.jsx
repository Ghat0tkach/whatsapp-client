...
function EmojiPickerApp({textRef,message,setMessage,showPicker,setShowPicker,setShowAttachment}) {
  ...
  return (
    <li>
        <button className='btn' type="button" onClick={(
          ...
          onChange={()=>setShowPicker((prev)=>!prev)}>
            {showPicker? <CloseIcon className="dark:fill-dark_svg_1"/> 
